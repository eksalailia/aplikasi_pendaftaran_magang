                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              <div class="main-menu-header">
                                  <img class="img-80 img-radius" src="backend/assets/images/avatar-4.jpg" alt="User-Profile-Image">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              <li>
                                  <a href="/datadiri-admin" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-id-badge"></i><b>FC</b></span>
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main">Data Diri</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>
                              <li>
                            ...
                            <li>
                                <a href="/pendaftaran-admin" class="waves-effect waves-dark">
                            ...
                            <li>
                                <a href="/mentor" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-user"></i><b>FC</b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Mentor</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
