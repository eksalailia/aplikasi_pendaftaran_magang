    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Aspirasi Peserta</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/admin-kesanpesan">Aspirasi Peserta</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                        ...
                        <div class="container mt-5" >
                            <div class="row justify-content-center align-items-center" style="margin-right: 170px">
                                <div class="card" style="width: 50rem; margin-left: 150px">
                                    <div class="card-header">
                                        <h5 style="font-size: 18px; font-family: Arial, Helvetica; text-align:center"><b>Detail Aspirasi Peserta</h5></b>
                                    </div>
                                    <div class="card-body">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item" style="font-size: 16px;"><b>Nama : </b>{{$message->nama}}</li>
                                            <li class="list-group-item" style="font-size: 16px;"><b>E-Mail : </b>{{$message->email}}</li>
                                            <li class="list-group-item" style="font-size: 16px;"><b>Subject : </b>{{$message->subject}}</li>
                                            <li class="list-group-item" style="font-size: 16px;"><b>Pesan: </b>{{$message->pesan}}</li>
                                        </ul>
                                    </div>
                                    <a class="btn btn-success mt-3" href="/admin-contact" style="font-size: 16px;"><i class="fas fa-reply"></i> Kembali</a>
                                </div>
                            </div>
                        </div>
...
<!-- messagetables -->
<script src="backend2/assets/js/plugin/messagetables/messagetables.min.js"></script>
