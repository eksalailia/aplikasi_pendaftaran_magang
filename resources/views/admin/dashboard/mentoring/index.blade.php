                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Data Mentoring Peserta PKL / Magang</h4>
                        </div>
                            ...
                            <br>
                            <a href="{{ route('admin.dashboard.mentoring.create') }}" class="btn btn-primary btn-round" style="margin-left:30px">Tambah Data <i class="fa fa-plus"></i></a>
                        </div>
                        <div class="card-body">
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ $mt->jurusan }}</td>
                                            <td>{{ $mt->semester }}</td>
                                            <td>{{ $mt->universitas }}</td>
                                            <td>
                                                <form action="{{ route('admin.dashboard.mentoring.destroy',$mt->id) }}"  method="POST">
                                                    <a class="btn btn-info" href="{{ route('admin.dashboard.mentoring.show',$mt->id) }}"><i class="fa fa-eye"></i></a>
                                                    <a href="{{ route('admin.dashboard.mentoring.edit',$mt->id) }}" class="btn btn-success "><i class="fa fa-edit"></i></a>
                                                    @csrf
                                                    @method('DELETE')
