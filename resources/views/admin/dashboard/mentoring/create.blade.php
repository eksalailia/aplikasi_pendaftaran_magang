...
<div class="main-panel">
    <div class="content">
        <div class="page-inner">
            ...
            <h4 class="page-title">Data Mentoring PKL / Magang</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/mentoring">Data Mentoring PKL / Magang</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Data Mentoring PKL / Magang</h4>
                        </div>
                                ...
                                @endif
                                <form method="POST" action="{{ route ('admin.dashboard.mentoring.create') }}" enctype="multipart/form-data"  >
                                    @csrf
