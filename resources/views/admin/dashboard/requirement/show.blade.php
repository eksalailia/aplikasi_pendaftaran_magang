                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                             <h4>Show Syarat & Ketentuan Pengajuan</h4>
                        </div>
                                ...
                                <div class="card" style="width: 50rem; margin-left: 150px">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item" style="font-size: 16px;"><b>Judul : </b>{{$requirement->judul}}</li>
                                            <li class="list-group-item" style="font-size: 16px;"><b>Isi : </b>{!! $requirement->isi !!}</li>
                                            <li class="list-group-item" style="font-size: 16px;"><b>Foto : </b><img src="/foto/{{ $requirement->foto }}" width="100px"></li>
                                        </ul>
                                    </div>
                                    <a class="btn btn-success mt-3" href="/requirement" style="font-size: 16px;"><i class="fas fa-reply"></i> Kembali</a>
                                </div>
                            </div>
                        </div>
