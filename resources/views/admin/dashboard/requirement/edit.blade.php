    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Syarat dan Ketentuan Pengajuan PKL / Magang</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/requirement">Syarat dan Ketentuan Pengajuan PKL / Magang</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                             <h4>Edit Syarat & Ketentuan Pengajuan</h4>
                        </div>
                        <form action="{{route('admin.dashboard.requirement.edit',$requirement->id)}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                        <div class="form-group col-sm-12">
                            <label>Foto</label>
                            <img src="{{asset('foto/'.$requirement->foto)}}" style="width: 500px; height: 250px;">
                            <input type="file" name="foto" class="form-control">
                            </div>
                        <div class="form-group col-sm-12">
                            <label>Judul</label>
                            <input type="text" id="judul" name="judul" class="form-control" required="" value="{{$requirement->judul}}" >
                        </div>
                        <div class="form-group col-sm-12">
                            <label>Isi</label>
                            <textarea class="ckeditor form-control valid" placeholder="Isi" id="isi" name="isi" required="" style="height: 150px"> {{$requirement->isi}} </textarea>
                        </div>
                        <div class="form-group col-sm-12">
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-check"></i> Simpan</button>
                        {{-- <input type="submit" value="Simpan" class="btn btn-success">&nbsp; --}}
                        <a href="/requirement" class="btn btn-secondary">
