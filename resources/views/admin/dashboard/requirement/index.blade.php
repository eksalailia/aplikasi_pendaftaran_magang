                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Daftar Syarat & Ketentuan Pengajuan</h4>
                        </div>
                        ...
                        <div class="card-tools">
                            <br>
                            <a href="{{ route('admin.dashboard.requirement.create') }}" class="btn btn-primary btn-round" style="margin-left:30px">Tambah Data <i class="fa fa-plus"></i></a>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('admin.dashboard.requirement.destroy',$rq->id) }}"  method="POST">
                                                    <a class="btn btn-info" href="{{ route('admin.dashboard.requirement.show',$rq->id) }}"><i class="fa fa-eye"></i></a>
                                                    <a href="{{ route('admin.dashboard.requirement.edit',$rq->id) }}" class="btn btn-success "><i class="fa fa-edit"></i></a>
                                                    @csrf
                                                    @method('DELETE')
