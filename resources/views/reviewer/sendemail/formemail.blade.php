    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Form E-Mail Notifikasi</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/requirement">Form E-Mail Notifikasi</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                             ...
                             <h4>Form E-Mail Notifikasi</h4>
                    </div>
        <form method="POST" action="{{ route ('reviewer.sendemail.send') }}" enctype="multipart/form-data"  >
            @csrf
                <div class="form-group col-sm-12">
                    <label>E-Mail Penerima</label>
                    <input type="email" id="email" name="email" class="form-control" required="" placeholder="E-Mail" >
                </div>
                <div class="form-group col-sm-12">
                    <label for="notes">Notes</label>
                    <textarea class="form-control" placeholder="Notes" id="notes" name="notes" style="height: 150px"></textarea>                
                </div>
