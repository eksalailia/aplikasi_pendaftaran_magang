    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Data Laporan Peserta PKL / Magang</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/laporan">Data Laporan Peserta PKL / Magang</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                             <h4>Show Data Laporan Peserta PKL / Magang</h4>
                        </div>
                        <div class="container mt-5" >
                            <div class="row justify-content-center align-items-center" style="margin-right: 170px">
                                <div class="card" style="width: 50rem; margin-left: 150px">
                                    <div class="card-header">
                                        <h5 style="font-size: 18px; font-family: Arial, Helvetica; text-align:center"><b>Detail Data Laporan Peserta PKL / Magang</h5></b>
                                    </div>
                                    <div class="card-body">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item" style="font-size: 16px;"><b>Nama Mentor : </b>{{ $laporan->users->name }}</li>
                                            <li class="list-group-item" style="font-size: 16px;"><b>Ketua Kelompok : </b>{{ $laporan->user->name }}</li>
